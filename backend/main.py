...
# df_cpsc_213_final = pd.read_csv('CPSC_213_Data_1.csv')
...
# Verify topic distribution to see how many posts each topic has
topic_counts = df_cpsc_213_final['topic_title'].value_counts()
print("Topic counts:")
print(topic_counts)
